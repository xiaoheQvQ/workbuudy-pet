...
export default {
  ...
  // --- 进程管理（ui.process.*）-------------------------------------------
  'ui.process.tab': '进程管理',
  'ui.process.searchPlaceholder': '搜索进程名 / PID / 端口，或输入 kill、netstat 等关键词',
  'ui.process.clearQuery': '清空搜索',
  'ui.process.refresh': '刷新',
  'ui.process.loading': '加载中…',
  'ui.process.keywords': '关键词',
  'ui.process.autoRefresh': '自动刷新',
  'ui.process.includePorts': '读取端口',
  'ui.process.onlyWithPorts': '只看占用端口',
  'ui.process.hintKill': 'kill / taskkill / tasklist / ps / process：默认按内存占用排序',
  'ui.process.hintNetstat': 'netstat：默认按端口数排序，列出进程及其占用端口',
  'ui.process.total': '共 {count} 个进程',
  'ui.process.shown': '显示 {count} 个',
  'ui.process.ports': '端口 {count} 个',
  'ui.process.elapsed': '耗时 {ms}ms',
  'ui.process.updated': '更新于 {time}',
  'ui.process.selected': '已选 {count} 个',
  'ui.process.clearSelection': '取消选择',
  'ui.process.killSelected': '结束所选',
  'ui.process.col.name': '进程名',
  'ui.process.col.pid': 'PID',
  'ui.process.col.memory': '内存',
  'ui.process.col.cpu': 'CPU',
  'ui.process.col.ports': '占用端口',
  'ui.process.col.actions': '操作',
  'ui.process.kill': '结束',
  'ui.process.forceKill': '强制结束',
  'ui.process.killing': '结束中…',
  'ui.process.self': '本应用',
  'ui.process.selfBlocked': '本应用自身进程不可结束',
  'ui.process.filterPort': '按端口 {port} 过滤',
  'ui.process.empty': '没有匹配的进程，换个进程名、PID 或端口试试',
  'ui.process.loadFailed': '读取进程失败：{error}',
  'ui.process.portsUnavailable': '未能读取端口占用（缺少 netstat / lsof），端口列与端口数排序暂不可用',
  'ui.process.detail.path': '路径',
  'ui.process.detail.cmd': '命令行',
  'ui.process.copyPid': '复制 PID',
  'ui.process.copyCmd': '复制命令行',
  'ui.process.copied': '已复制{label}',
  'ui.process.copyFailed': '复制失败',
  'ui.process.confirmTitle': '结束进程',
  'ui.process.confirmBody': '将结束以下 {count} 个进程，未保存的数据会丢失：',
  'ui.process.confirmMore': '其余 {count} 个…',
  'ui.process.forceHint': '强制结束（不做优雅退出，可能丢失未保存数据）',
  'ui.process.confirmTip': '系统关键进程被结束后可能导致桌面或系统异常，请确认后再操作',
  'ui.process.killOk': '已结束 {name}',
  'ui.process.killOkBatch': '已结束 {count} 个进程',
  'ui.process.killFail': '{count} 个进程结束失败：{error}'
} as const
